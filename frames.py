...
def create_dotted(size: tuple[int, int], bg_color: tuple[int, int, int], dot_color: tuple[int, int, int], pattern_mode: str) -> tuple[Image.Image, str]:
    """Backward-compatible alias for older merged code paths."""
    return create_dotted_background(size, bg_color, dot_color, pattern_mode)
